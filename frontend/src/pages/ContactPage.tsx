...
export default function ContactPage() {
  ...
  useEffect(() => {
    document.title = "Contacto — KAIZEN LAB";
  }, []);
      ...
      <section className="mx-auto max-w-6xl px-4 pb-10 pt-12 sm:px-6 sm:pt-20">
        <div className="text-center">
          ...
          <p className="mx-auto mt-3 max-w-xl text-sm text-muted-foreground">
            Cuéntanos qué quieres decorar y te ayudamos a elegir el poster o cuadro ideal.{" "}
            {SITE.coverage}.
          </p>
        </div>
      </section>
            ...
            <div className="mt-5 grid gap-4">
              ...
              <div>
                ...
                <Textarea
                  ...
                  placeholder="Ej: Quiero un poster metálico para mi setup con estilo gamer…"
                  rows={5}
                  className="mt-1.5 bg-background/50"
                />
              </div>
              ...
              <ul className="mt-4 space-y-4 text-sm">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-muted-foreground">{contact?.address || SITE.coverage}</div>
                  </div>
                </li>
              </ul>
            </div>
